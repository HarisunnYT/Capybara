...
//            float4 _CameraOpaqueTexture_ST;
            ...
            LUX_TEXTURE2D_X(_CameraOpaqueTexture);
...
//  Fix screenUV for Single Pass Stereo Rendering
        ...
        screenUV.xy = UnityStereoTransformScreenSpaceTex(screenUV.xy);
            ...
            //  Somehow handle orthographic projection
                ...
                float refractedSceneDepth = LUX_LOAD_TEXTURE2D_X(_CameraDepthTexture, _CameraDepthTexture_TexelSize.zw * saturate(screenUV + offset) * 0.9999f ).x;
            ...
            //  Do not refract pixel of the foreground
                    ...
                    refractedSceneDepth = LUX_LOAD_TEXTURE2D_X(_CameraDepthTexture, _CameraDepthTexture_TexelSize.zw * saturate(offset) * 0.9999f ).x;

                    //refraction = SAMPLE_TEXTURE2D(_CameraOpaqueTexture, sampler_CameraOpaqueTexture, ( offset ) ).rgb;
                    refraction = LUX_SAMPLE_TEXTURE2D_X(_CameraOpaqueTexture, sampler_LinearClamp, saturate(offset)).rgb;
...
//color.rgb = viewDepth;
    ...
    CustomEditor "LuxLWRPCustomWaterShaderGUI"
}
